...
export default function Features({
  ...
  return (
    <div className="overflow-hidden bg-transparent pt-32 sm:py-16 w-screen"
      id={titleId}
    >
      <div 
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-16 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          ...
          <div className="relative pt-24 min-h-[30rem] md:min-h-none max-h-[25rem]">
            <Image
              ...
              src={image.src}
              alt={image.alt}
              className="lg:block max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem] md:-ml-4 lg:-ml-0"
            />
          </div>
        </div>
      </div>
